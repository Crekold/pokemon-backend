...
public class PokemonController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDTO> createPokemon(@RequestBody PokemonDTO pokemonDTO) {
        LOG.info("API Acceso: Creación de Pokemon.");
        try {
            PokemonDTO createdPokemon = pokemonService.savePokemon(pokemonDTO);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseDTO> updatePokemon(@PathVariable String id, @RequestBody PokemonDTO pokemonDTO) {
